  ...
  wayland.windowManager.hyprland.settings = {
    bindd =
      ...
      ++ [
        ...
        #"$modifier,SPACE, Toggle Special, togglespecialworkspace" # I don't think I have this lol
        ...
        #=============== SESSION CONTROL =======================
        "$modifier CTRL,L, Turn off keyboard and lock, exec, brightnessctl -d '*::kbd_backlight' set 0% & hyprlock"
      ];
